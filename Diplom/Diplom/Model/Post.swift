...
struct PostModel {
    ...
    static func makeMockModel() -> [PostModel] {
        ...
        model.append(PostModel(author: "Джим Рейнор о Саре Керриган", description: "... В тот день началась наша революция. В день, когда Менгск уничтожил целую планету и назвал это «справедливостью...", image: "Kerrigan", likes: 2473 , isLiked: false, views: 2602))
        model.append(PostModel(author: "За АЙУР!", description: "Наш гордый народ был обречён на изгнание, но никто не разрушит наше единство, ибо нас связывает Кхала — священный союз всех наших мыслей и эмоций. Сегодня мы вернём родной мир! И с ним — наше наследие!", image: "For AIUR!", likes: 8671, isLiked: false, views: 13285))
